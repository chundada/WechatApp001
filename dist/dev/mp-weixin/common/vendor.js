...
const addInterceptor = defineSyncApi(API_ADD_INTERCEPTOR, (method, interceptor2) => {
  if (isString(method) && isPlainObject$1(interceptor2)) {
...
const removeInterceptor = defineSyncApi(API_REMOVE_INTERCEPTOR, (method, interceptor2) => {
  if (isString(method)) {
    if (isPlainObject$1(interceptor2)) {
...
function fullKey(key) {
  const appid = "__UNI__SLIM_PARTNER";
...
function getVue3TitleMap() {
  ...
  titleMapCache = {};
  try {
    const raw = '{"pages/index/index":"瘦身搭档","pages/record/index":"体重记录","pages/chart/index":"数据统计","pages/friends/index":"好友对比","pages/competition/index":"挑战赛","pages/achievements/index":"我的成就","pages/profile/index":"个人中心"}';
...
const STAT_VERSION_PUBLIC = "5.13";
...
function getAppId$1() {
  var _a;
  return (_a = "__UNI__SLIM_PARTNER") !== null && _a !== void 0 ? _a : "";
}
...
function getMpTdaid(platform) {
  ...
  switch (platform) {
    ...
    case "qq": {
      ...
      const envId = "__UNI__SLIM_PARTNER";
...
function getEnvAppName() {
  var _a;
  return (_a = "瘦身搭档") !== null && _a !== void 0 ? _a : "";
}
